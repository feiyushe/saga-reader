...
Denies the get_feeds_packages command without any pre-configured scope.
...
Denies the search_contents_by_keyword command without any pre-configured scope.
